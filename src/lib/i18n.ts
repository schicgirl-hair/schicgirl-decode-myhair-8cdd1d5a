...
const ui: Translations = {
  ...
  sendToEmail: { fr: "Envoyer à mon email", en: "Send to my email" },
  emailSent: { fr: "Résultats envoyés à ton email !", en: "Results sent to your email!" },
  emailFailed: { fr: "Échec de l'envoi. Réessaie.", en: "Failed to send. Try again." },
  sendingEmail: { fr: "Envoi en cours...", en: "Sending..." },
